...
module.exports = class TymlyGatherer {
  ...
  async getService (pluginName, servicePath, messages) {
    ...
    //
    await this.getMainIndex(path.join(servicePath, 'index.js', messages), service)
  ...
  async getMainIndex (indexPath, assignee, messages) {
    try {
      ...
      messages.push(`Problem getting main index.js file for ${indexPath}`)
    }
  }
