...
module.exports = class TymlyGatherer {
  ...
  async generateDocumentation (indexPath, options, messages) {
    ...
    const produced = fs.readFileSync(path.join(options.outputDirPath, options.outputFile)).toString()
    if (produced === '<!-- Generated by documentation.js. Update this documentation by updating the source code. -->\n') {
