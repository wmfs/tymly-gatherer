...
module.exports = class TymlyGatherer {
  ...
  async generateDocumentation (indexContent, options) {
    // Assume options.outputFilePath=c:\blah\${pluginName}.md
    console.log(`Writing ${JSON.stringify(indexContent, null, 2)} to ${options.outputFilePath}`)
  }
