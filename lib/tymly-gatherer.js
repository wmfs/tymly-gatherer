...
module.exports = class TymlyGatherer {
  ...
  async listStateResourceSummary (pluginsPath, pluginName, target) {
  ...
  async listPluginSummary () {
    ...
    for (const plugin of pluginDirPaths) {
      ...
      await this.listStateResourceSummary(pluginsPath, pluginDetail.name, pluginSummary)
      await this.listServiceSummary(pluginsPath, pluginDetail.name, pluginSummary)
    }

    return pluginSummary
  }

  async listServiceSummary (pluginsPath, pluginName, target) {
